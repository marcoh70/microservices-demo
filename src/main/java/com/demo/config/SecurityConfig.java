...
import com.demo.exception_handling.CustomAccessDeniedHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .requiresChannel(rcc -> rcc.anyRequest().requiresInsecure()) // accepts http not https
        ...
        // Global configuration for EntryPoint authentication
